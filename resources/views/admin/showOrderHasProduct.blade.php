    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3 p-3  bg-secondary  text-white">
                <div class="container">
                    <div class="m-1">customer order : order has {{$count}} item</div>
                    ...
                    <table class="table table-dark table-striped">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a href="{{ url('changestatus/' . "$item->id/" . 'Order_processing') }}"
                                                    class="dropdown-item">Order processing</a>
                                            </li>
                                            <li><a href="{{ url('changestatus/' . "$item->id/" . 'On_the_way') }}"
                                                    class="dropdown-item">On the way</a>
                                            </li>
                                            <li><a href="{{ url('changestatus/' . "$item->id/" . 'Delivered') }}"
                                                    class="dropdown-item">Delivered</a>
                                            </li>
                                            <li><a href="{{ url('changestatus/' . "$item->id/" . 'confirm_Delivered') }}"
                                                    class="dropdown-item">confirm Delivered</a>
                                            </li>
                                            <li><a href="{{ url('changestatus/' . "$item->id/" . 'canceled') }}"
                                                    class="dropdown-item"
                        ...
                        @endforeach
                                        ...
                                        <a href="{{route('orderHasProduct')}}"><button class="btn btn-success">Back</button></a>
